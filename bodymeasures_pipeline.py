...
FILE_PATTERN = "BodyMeasures_data/*.xpt"
FEATURES_TO_KEEP = ['SEQN', 'BMXBMI', 'BMXWAIST']
OUTPUT_FILENAME = "bodyMeasures_preproccesed_data.csv"
...
def bodymeasures_pipeline(file_pattern=FILE_PATTERN, features_to_keep=FEATURES_TO_KEEP, output_name= OUTPUT_FILENAME):
    combined_df = data_ingestion(file_pattern, features_to_keep)
    combined_df.to_csv(output_name, index=False)
    print("saved the file bodyMeasures_preproccesed_data.csv into the same folder as this python file")